...
export const defaultProjectIdeas = {
  "2025": {
    "supporting-charities": [
      // This is just a sample entry - your actual data will be much more extensive
      {
        id: "sc1",
        title: "Simple Charity Collection Box",
        description:
          "Basic wooden donation box with coin slot and secure lock. Students learn basic woodworking skills including measuring, cutting, drilling, and finishing. Includes safety lock mechanism and coin counting access panel.",
        materialType: "resistant",
        difficulty: "basic",
        ability: "low",
        machinery: ["Hand tools", "Drill", "Sandpaper", "Wood finish applicator"],
        materials: ["Pine wood (15mm)", "Hinges", "Padlock", "Wood stain", "Screws", "Felt padding"],
        timeEstimate: "3-4 weeks",
        sustainable: true,
        detailedSteps: [
          "Week 1: Design and measure box dimensions, cut wood pieces",
          "Week 2: Drill holes, assemble main structure",
          "Week 3: Add hinges, lock mechanism, and coin slot",
          "Week 4: Sand, stain, and final assembly",
        ],
        learningOutcomes: ["Basic woodworking", "Measuring and marking", "Safe tool use", "Finishing techniques"],
      ...
      // Your other supporting-charities projects would be here
    ],
    "reducing-waste": [
      // Your reducing-waste projects would be here
    ],
    "home-products": [
      // Your home-products projects would be here
    ],
  },
}
